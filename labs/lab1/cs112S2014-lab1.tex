...
\section*{Compiling, Running, and Understanding Java Programs}
  ...
  output? How is the output similar to and different from that which was created by the {\tt Hooray} program? After you
...
\section*{Summary of the Required Deliverables}
  ...
  \begin{enumerate}
    ...
    \item The one-page report that clearly responds to the four previously stated prompts
...
assigned to a team that is tasked with ensuring that all of its members are able to complete each step of the
...
conversations, you should not share source code or full command lines with your team members. To ensure that you
can communicate effectively, members of each team should sit next to each other in the room.  Please see the
