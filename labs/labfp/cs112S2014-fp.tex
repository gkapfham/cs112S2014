...
\section*{Frequency Analysis with Hashtables}
  ...
  % \begin{itemize}
  %   \itemsep0in
  %   \item For each of the priorities inside of the Todo.txt file, how many tasks are categorized with each one?
  %   \item For each of the contexts inside of the Todo.txt file, how many tasks are associated with each of them?
  %   \item For each of the projects
  % \end{itemize}
