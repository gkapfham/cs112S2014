...
about the execution time, in milliseconds, of the chosen sorting algorithms. You should create tables of table that
record all of the execution times of all of the sorting algorithms. In particular, you must run the sorting algorithms
for arrays of size 10, 100, 1,000, 10,000, and some value larger than 10,000; please note that experiments 
with arrays larger than size 100,000 could be very time consuming because some algorithms are very slow.

You should write a detailed report of your experimental study of the sorting algorithms.  Your report should review your
experiment design by clearly describing the commands that you type and the order in which the commands were typed.  It
should also include tables of results that actually list the running times for each of the sorting algorithms.  Reports
will not be accepted unless the tables of data and the paragraphs of analysis are properly justified.  You should label
